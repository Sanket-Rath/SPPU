    ...
    <div className="flex flex-1">
      ...
      <main className="flex-1 p-6 space-y-6">
        <section>
          ...
          <p className="mb-4">
            SPPU is well-connected by road, rail, and air. The campus is easily
            accessible from all parts of Pune city and beyond.
          </p>
        ...
        <section className="bg-card rounded-lg border shadow-sm p-4 space-y-3">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              View Savitribai Phule Pune University on Google Maps. Click the
              map preview below to open full directions in a new tab.
            </p>
          </div>
